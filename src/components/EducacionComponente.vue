...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.'},
  {fecha: '2022', title: 'Platzi - Full Stack Web Developer', descripcion: 'Escuela de Desarrollo Web'},
  {fecha: '2022', title: 'Soy Henry Bootcamp', descripcion: 'Henry Bootcamp. +800 horas de cursado teórico practico.'},
